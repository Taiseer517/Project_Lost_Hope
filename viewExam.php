...
<html lang="en">
  ...
  <body>
    ...
    <div class="nav">
      ...
      <div style="display:flex;justify-content:space-evenly;margin-top:15px;">
        ...
        <input type="text" style="background-color:#204aca;height:36px;cursor: pointer;border-radius: 5px;
           ...
           outline:none;text-align:center;color:#fff;width:250px;margin-top:0px;" 
    ...
    <input type="submit" style="background-color:#204aca;margin-top:20px;" name="submit" value="Submit" class="submitButton">
   </form>    
