...
<div class="background">
      ...
      <li>
        <button onclick="overallPlo()" style="width:300px;margin-left:20%;" class="School-wise">Overall PLO</button><br><br>
        <button onclick="coWisePlo()" style="width:300px;margin-left:20%;" class="Department-wise">CO Wise PLO</button><br><br>
        <button onclick="courseWisePlo()" style="width:300px;margin-left:20%;" class="Program-wise">Course Wise PLO</button>
      </li>
      </div>
