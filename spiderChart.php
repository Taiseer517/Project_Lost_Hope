...
<!-- div row-1 starts here -->
     <div style="display:flex;justify-content:center;padding-top:30px;" class="row1">
     <form method="POST">
    ...
    <div style="display:flex;justify-content:center;margin-top:10px;">
        ...
        <button onclick="poView()" style="width:180px;" class="viewButton">view PO analysis</button>
        <button onclick="coView()" style="width:180px;" class="viewButton">View CO analysis</button>
    
    </div> <!-- div row-2 ends here -->

        <div style="display:flex;justify-content:center;margin-top:20px;height:600px;width:100%;"class="row3"> 
