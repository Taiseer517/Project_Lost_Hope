...
<div class="background">
      ...
      <div style="height:80px;"class="row1">
        <form method="POST">
        <input style="background-color:#204aca;height:50px;border: 1px solid;cursor: pointer;border-radius: 5px;font-size: 14px;letter-spacing:2px;
                      font-weight: bold;text-transform:uppercase; border: none;outline: none;text-align: center;margin-right:20px;
                      color:white;margin-left:40%;margin-top:50px;" type="text" placeholder="Enter Student ID" name="studentID"/>
      ...
      <li>
        <button onclick="ploAnalysisWithDepartmentAverage()" style="width:300px;margin-left:20%;" class="School-wise">PLO Analysis with Department Average</button><br><br>
        <button onclick="ploAnalysisWithProgramAverage()" style="width:300px;margin-left:20%;" class="Department-wise">PLO Analysis with Program Average</button><br><br>
        <button onclick="ploAnalysisWithSchoolAverage()" style="width:300px;margin-left:20%;" class="Program-wise">PLO Analysis with School Average</button>
      </li>
      </div>
