...
<div class="background">
     ...
     <select style="background:#204aca;margin-left:10px;margin-top:40px;" name="departmentID" class="select">
     ...
     <select style="background:#204aca;margin-left:10px;" name="year" class="select">
       <option disabled selected>Year</option>
       <option value="2020">2020</option>
       <option value="2021">2021</option>
       <option value="2022">2022</option>
     </select>
       <input style="background:#204aca;border-radius:10px;border:none;outline:none;color:#fff;font-size:14px;letter-spacing:2px;
        ...
        <!-- div row-2 -->
        <div style="height:50px;padding-left:43%;margin-top:20px;">
        <button onclick="view()" style="height: 46px;width: 200px;margin-left:25px;display:inline-block;border-radius: 12px;
