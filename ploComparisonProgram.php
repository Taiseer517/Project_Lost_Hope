...
<div class="background">
     ...
     <select style="background:#204aca;margin-left:10px;" name="programID" class="select">
     ...
     <select style="background:#204aca;margin-left:10px;margin-top:40px;" name="year" class="select">
