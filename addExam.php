...
<html lang="en">
  ...
  <form action="addExamConfig.php" method="POST">
      <div style="display:flex;justify-content:space-evenly;margin-top:15px;">
        ...
        <input type="text" style="background-color:#204aca;;height:36px;cursor: pointer;border-radius: 5px;
      ...
      <select style="background-color:#204aca;width:250px;margin-left:0px;margin-top:0px;" name="courseID" class="select">
    ...
    <select style="background-color:#204aca;width:250px;margin-left:0px;margin-top:0px;" name="sectionNum" class="select">
  ...
  <!-- div row-1 ends here -->
    ...
    <select style="background-color:#204aca;margin-left:0px;width:250px;margin-top:0px;" name="questionCount" class="select">
    ...
    <select style="background-color:#204aca;width:250px;margin-left:0px;margin-top:0px;" name="semester" class="select">
     ...
     <select style="background-color:#204aca;width:250px;margin-top:0px;margin-left:0px;" name="year" class="select">
    ...
    <div style="background-color:#063a8d;margin-top:15px; width:85%;" class="background">
