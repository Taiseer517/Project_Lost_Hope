...
<div class="background">
     ...
     <input style="background-color:#204aca;margin-top:50px;height:40px;border: 1px solid;cursor: pointer;border-radius: 5px;
     ...
     <select style="background-color:#204aca;margin-left:10px;" name="year" class="select">
       ...
       <input style="background:#204aca;border-radius:10px;border:none;outline:none;color:#fff;font-size:14px;letter-spacing:2px;
        ...
        <!-- div row-2 -->
        <div style="height:50px;padding-left:43%;margin-top:60px;">
