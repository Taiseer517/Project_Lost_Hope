  ...
  <body>
    ...
    <div class="nav">
      ...
      <div class="row1">
        ...
        style="background:#204aca">
            <option disabled selected>Year</option>
             <option value="2020">2020</option>
             <option value="2021">2021</option>
             <option value="2022">2022</option>
         </select>
             <input style="background:#204aca;;
              border-radius:10px;
              border:none;
              outline:none;
              color:#fff;
      ...
      style="height:50px;display:flex;justify-content:space-around;">
        ...
        style="background:#204aca;margin-left:20px;width:250px;height:100%;margin-top:0px;border-radius:15px;">
         ...
         <select name="courseInstructor2" class="select"
            style="background:#204aca;margin-left:20px;width:250px;height:100%;margin-top:0px;">
             <option disabled selected>Course Instructor</option>
             <option value="4275">Tahsin F.Ara Nayna</option>
             <option value="4361">Shovasis Kumar Biswas</option>
             <option value="4351">Nabila Rahman Nodi</option>
         ...
         <select name="courseInstructor3" class="select"
            style="background:#204aca;margin-left:0px;width:250px;height:100%;margin-top:0px;">
            <option disabled selected>Course Instructor</option>
             <option value="4275">Tahsin F.Ara Nayna</option>
             <option value="4361">Shovasis Kumar Biswas</option>
             <option value="4351">Nabila Rahman Nodi</option>
      ...
      <div style="height:50px;width:100px;padding-left:43%;margin-top:15px;">
      <button onclick="viewInstructorWise()" style="background:#204aca;height: 46px;width: 100px;margin-left:50px;display:inline-block; border-radius: 10px; border: none;outline: none;background:#00BFFF;color: #fff;font-size: 14px;letter-spacing:2px;text-transform: uppercase;cursor:pointer;font-weight: bold;">
        view</button>
      </div>
