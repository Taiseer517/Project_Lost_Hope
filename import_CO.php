...
if(isset($_POST["import"])){
    ...
    if($_FILES['file']["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
            ...
            if(count($column) == 4 && !empty($column[0]) && !empty($column[1]) && !empty($column[2]) && !empty($column[3])){
                $sqlInsert = "Insert into co_t (coNum, courseID, ploID, poID) values ('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "')";
