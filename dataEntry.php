  ...
  <body>
    ...
    <div class="nav">
        ...
        <div class="nav-links">
          ...
          <li><a href="import_CO.php" target="_self">Upload CO</a></li>
          <li><a href="import_StudentEnrollment.php" target="_self">Upload Student Enrollment</a></li>
          <li><a href="manual_form.php" target="_self">Student Enrollment Input</a></li>
          <li><a href="import_performance.php" target="_self">Upload Student GPA</a></li> -->
